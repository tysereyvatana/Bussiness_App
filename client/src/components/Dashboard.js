...
// --- UPDATE THIS COMPONENT to be a clickable button ---
const StatCard = ({ icon, title, value, isLoading, onClick }) => (
    <button
        onClick={onClick}
        disabled={isLoading}
        className="bg-gray-800 p-6 rounded-lg flex items-center space-x-4 text-left w-full transition-transform transform hover:scale-105 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
    >
...
// --- UPDATE THIS COMPONENT SIGNATURE to accept onNavigate ---
const Dashboard = ({ currentUser, socket, onNavigate }) => {
    ...
    return (
        <div className="p-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* --- UPDATE THIS SECTION to add onClick handlers --- */}
