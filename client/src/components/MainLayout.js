...
const RepairIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 00-1-1v-1a2 2 0 10-4 0v1a1 1 0 00-1 1H7a1 1 0 01-1-1v-3a1 1 0 011-1h1a2 2 0 100-4H7a1 1 0 01-1-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" /></svg>;
const BrandIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5V4H4zm0 11h5v5H4v-5zm11-11h5v5h-5V4zm0 11h5v5h-5v-5z" /></svg>;
            ...
            <aside className="w-64 flex-shrink-0 bg-gray-800 p-4 flex flex-col justify-between">
                <div>
                    ...
                    <nav className="space-y-2">
                        ...
                        <NavItem icon={<RepairIcon />} label="Repair Jobs" view="repair_jobs" activeView={activeView} onNavigate={onNavigate} />
                        <NavItem icon={<CustomersIcon />} label="Customers" view="customers" activeView={activeView} onNavigate={onNavigate} />
                        <NavItem icon={<ServicesIcon />} label="Services" view="services" activeView={activeView} onNavigate={onNavigate} />
                        <NavItem icon={<BrandIcon />} label="Item Brands" view="item_brands" activeView={activeView} onNavigate={onNavigate} />
                        <NavItem icon={<UsersIcon />} label="Users" view="users" activeView={activeView} onNavigate={onNavigate} />
